      ...
      <DataTable
        ...
        emptyState={
          <EmptyState
            ...
            action={<Button onClick={() => setFormOpen(true)}>+ לקוח חדש</Button>}
          />
        }
      >
        {clients.map((client) => (
          <>
            ...
            >
              ...
              <td className="px-4 py-3 text-gray-600" dir="ltr">{client.contact_email ?? '—'}</td>
              <td className="px-4 py-3 text-gray-600" dir="ltr">{client.contact_phone ?? '—'}</td>
