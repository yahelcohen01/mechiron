  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">חברי צוות</h2>
        ...
        {members.map((member) => (
          <div key={member.id} className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-4">
            ...
            <div className="flex flex-col gap-1 text-sm text-gray-600 dark:text-gray-400">
              ...
              <span className="text-xs text-gray-400 dark:text-gray-500">הצטרף {formatDate(member.created_at)}</span>
            </div>
          </div>
        ))}
      </div>
      ...
      {pendingInvites.length > 0 && (
        <div className="flex flex-col gap-3">
          <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">הזמנות ממתינות</h3>
